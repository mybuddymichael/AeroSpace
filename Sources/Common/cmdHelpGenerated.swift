...
let fullscreen_help_generated = """
    USAGE: fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--width <1..100>]
       OR: fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--width <1..100>] [--fail-if-noop]
