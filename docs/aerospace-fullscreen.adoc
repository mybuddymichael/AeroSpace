...
[verse]
// tag::synopsis[]
aerospace fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--width <1..100>]
aerospace fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--width <1..100>] [--fail-if-noop]
...
`--width <1..100>` allows entering fullscreen with partial width while preserving full height.
The window remains centered horizontally.
...
--width <1..100>:: Set fullscreen width as a percentage of available width and center window horizontally
